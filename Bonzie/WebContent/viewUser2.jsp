...
<body>
<a href="addUser.jsp">Them User</a>
	<%
	...
	<div class="container">
		<div class="account">
			<form action="EditUserPost.jsp" method="post">
				<div>
					<span class="text">ID- Mã số:</span>
					<input name="id" type="text" value="${user.id }"/><br />
				</div>
				<div>
				...
				<div>	
					<span class="word">Điện thoại:</span>
					<input name="phone" type="text" value="${user.phone }"><br />
				</div>
				<div>	
	
					<span class="word">Giới thiệu:</span>
					<input rows="3" cols="55" name="about" type="text" value="${user.about }"><br />
				</div>
				<div>		
					<br /> 
					<span class="word">Vai trò:</span>  
					<c:choose>
...
if (favourites.contains("Xem phim") && favourites.contains("Nghe nhac") ){%>
				...
				<%
} else if (favourites.contains("Nghe nhac") ){%>
...
<br> 			
					...
					<input type="submit" value="Sua người dùng" class="login-button"
